            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    CockpitCard(
                        ...
                        let progress = SpacedRepetitionService.shared.getProgressByLevel(allWordIds: allWordIds)
                        let readinessPercentage = SpacedRepetitionService.shared.getReadinessPercentage(allWordIds: allWordIds)
